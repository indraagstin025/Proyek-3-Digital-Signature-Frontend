    ...
    <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-white/30 dark:bg-black/20 backdrop-blur-md transition-opacity duration-700 animate-fadeIn">
      ...
      <div className="relative bg-transparent p-10 max-w-sm w-full mx-4 text-center overflow-visible">
        ...
        <div className="relative mx-auto mb-8 w-32 h-32 flex items-center justify-center">
          ...
          {/* Icon Tengah */}
          <div className="relative z-10 text-5xl text-blue-700 dark:text-white drop-shadow-lg transition-all duration-700 transform scale-110">
            {steps[currentStep].icon}
          </div>
        </div>

        {/* Teks Status */}
        <h3 className="text-2xl font-bold text-slate-800 dark:text-white mb-3 tracking-wide drop-shadow-sm transition-all duration-500">
            Memproses...
        </h3>

        <p className="text-slate-600 dark:text-blue-100 text-sm font-semibold min-h-[24px] transition-all duration-700 ease-in-out">
