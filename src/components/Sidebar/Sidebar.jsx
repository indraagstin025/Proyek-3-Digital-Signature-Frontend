    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <path d="M4 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V5z" />
        </svg>
      ),
    },
    {
                  ...
                  <div key={link.id} className="space-y-1">
                    <button
                      ...
                      className={`w-full flex items-center justify-between py-2.5 px-4 rounded-lg font-semibold transition-colors ${
                        isActive ? "text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-slate-800" : "text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"
                      }`}
                    >
                      ...
                      {isWorkspaceOpen ? <HiChevronDown className="w-4 h-4" /> : <HiChevronRight className="w-4 h-4" />}
                    </button>
                          ...
                          return (
                            <button
                              ...
                              className={`w-full flex items-center gap-3 py-2 px-4 rounded-lg text-sm font-medium transition-colors ${
                                isChildActive ? "bg-blue-600 text-white shadow-sm" : "text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"
                              }`}
                            >
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 py-2.5 px-4 rounded-lg font-semibold transition-colors ${
                    isActive ? "bg-blue-600 text-white shadow-md" : "text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"
                  }`}
                >
                  {link.icon}
                  <span>{link.label}</span>
        ...
        <div className="p-4 border-t border-slate-200/80 dark:border-white/10 shrink-0 z-20 bg-white dark:bg-slate-900">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="shrink-0">
              {userAvatar ? (
                // Opsi 1: Tampilkan Foto jika ada
                <img 
                    src={userAvatar} 
                    alt="User Avatar" 
                    className="w-10 h-10 rounded-full object-cover bg-slate-200 dark:bg-slate-700 ring-2 ring-white dark:ring-slate-800" 
                />
              ) : (
                // Opsi 2: Tampilkan Inisial dengan Gradient jika tidak ada foto
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center font-bold text-lg ring-2 ring-white dark:ring-slate-800 shadow-sm">
