      ...
      >
        ...
        <div id="sidebar-profile-section" className="p-4 border-t border-slate-200/80 dark:border-white/10 shrink-0 z-20 bg-white dark:bg-slate-900">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2 px-4 mb-2 rounded-lg font-medium bg-amber-50 dark:bg-amber-900/10 text-amber-600 dark:text-amber-500 hover:bg-amber-100 dark:hover:bg-amber-900/30 transition-colors text-sm"
          >
