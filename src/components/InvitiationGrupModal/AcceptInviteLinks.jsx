    ...
    <div className="fixed inset-0 bg-black/50 z-40 flex items-center justify-center">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg z-50 w-full max-w-sm">
        ...
        <p className="text-slate-600 dark:text-gray-400 mb-6">
          Anda telah diundang untuk bergabung ke grup.
        </p>
        ...
        <div className="flex gap-4">
          <button
            ...
            disabled={isPending}
            className="w-full px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-slate-800 dark:text-white hover:bg-gray-300 disabled:opacity-50"
          >
            Nanti
          </button>
          <button
            ...
            disabled={isPending}
            className="w-full px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 flex items-center justify-center"
          >
            {isPending ? (
