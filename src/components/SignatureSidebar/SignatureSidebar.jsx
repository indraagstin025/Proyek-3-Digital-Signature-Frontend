...
const SignatureSidebar = ({ savedSignatureUrl, onOpenSignatureModal, onSave, isLoading, includeQrCode, setIncludeQrCode, isOpen, onClose, onAnalyze, readOnly = false, isSignedSuccess = false, onViewResult = () => {} }) => {
  ...
  return (
    <aside
      className={`
        select-none  /* <--- TAMBAHAN: Mencegah teks di-blok/select */
