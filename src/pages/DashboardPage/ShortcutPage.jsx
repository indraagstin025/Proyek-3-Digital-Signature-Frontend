...
const WelcomeBanner = ({ userName, onUploadClick, onCreateGroupClick }) => {
  return (
    <div
      ...
      p-6 sm:p-10 text-white shadow-xl shadow-blue-500/20 mb-10 transition-all hover:shadow-2xl group"
    >
      {/* Background Pattern - Animated */}
      <div className="absolute top-0 right-0 -mt-10 -mr-10 h-64 w-64 rounded-full bg-white opacity-10 dark:opacity-5 blur-3xl pointer-events-none group-hover:scale-110 transition-transform duration-1000"></div>
      <div className="absolute bottom-0 left-0 -mb-10 -ml-10 h-40 w-40 rounded-full bg-white opacity-10 dark:opacity-5 blur-2xl pointer-events-none group-hover:scale-110 transition-transform duration-1000"></div>

      <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        <div>
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-3 text-white dark:text-blue-50 tracking-tight">
            Halo, {userName}! 👋
          </h2>
          <p className="text-blue-50 dark:text-slate-300 max-w-lg text-base sm:text-lg leading-relaxed font-medium opacity-90">
            Selamat datang di Workspace Anda. Akses cepat untuk memulai produktivitas Anda hari ini.
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-4 w-full md:w-auto">
          ...
          <button 
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-white text-blue-700 hover:bg-blue-50 px-6 py-3.5 rounded-xl font-bold shadow-lg shadow-blue-900/10 transition-all hover:-translate-y-0.5 active:scale-95 active:translate-y-0"
          >
          ...
          <button
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-white/20 hover:bg-white/30 text-white px-6 py-3.5 rounded-xl font-semibold backdrop-blur-md border border-white/30 transition-all hover:-translate-y-0.5 active:scale-95"
          >
    ...
    <div className="h-full w-full overflow-y-auto custom-scrollbar p-6 sm:p-8 fade-in bg-slate-50/50 dark:bg-[#0f172a]">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 pl-1 border-l-4 border-indigo-500">
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-1 pl-3">
            Menu Pintasan
          </h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm pl-3">
            Akses cepat ke seluruh modul dan fitur utama aplikasi.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6 flex flex-col h-full relative z-10">
                <div className="flex items-start justify-between mb-4">
                    {/* Icon Container */}
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-white shadow-lg bg-gradient-to-br ${item.gradient} group-hover:scale-110 transition-transform duration-300`}>
                    {item.icon}
                    </div>
