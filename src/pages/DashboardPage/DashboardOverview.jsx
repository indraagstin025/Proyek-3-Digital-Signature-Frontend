...
import { FaFileSignature, FaClock, FaCheckCircle, FaSpinner, FaUsers, FaBoxOpen, FaUser, FaArrowRight, FaPenFancy, FaChartPie, FaFolderOpen, FaArrowUp, FaEllipsisH } from "react-icons/fa";
import { toast } from "react-hot-toast";
import { dashboardService } from "../../services/dashboardService";

// --- MODERN STAT CARD (DENGAN PERBAIKAN DARK MODE) ---
const StatCard = ({ icon, label, value, colorTheme }) => {
  const themes = {
    blue: {
      ...
      // [UPDATE] Warna glow untuk dark mode
  ...
  return (
    <div
      ...
      /* [UPDATE] Background kartu lebih terang & Border lebih tegas */
      bg-white/80 dark:bg-slate-800/50 backdrop-blur-xl 
      border border-white/60 dark:border-slate-600/40
      shadow-lg shadow-slate-200/50 dark:shadow-md ${theme.darkGlow}`}
    >
      <div className="flex justify-between items-start z-10 relative">
        <div>
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${theme.light} ${theme.text} flex items-center gap-1`}>
...
// --- MODERN ACTION CARD (DENGAN PERBAIKAN DARK MODE) ---
const ActionCard = ({ doc, navigate }) => {
  ...
  let cardBorder = "border-l-4 border-l-slate-300 dark:border-l-slate-600"; // [UPDATE] Border kiri disesuaikan
  ...
  return (
    <div
      className={`group relative rounded-xl p-5 transition-all duration-300 ${cardBorder}
      /* [UPDATE] Background kartu lebih terang & Border lebih tegas */
      bg-white/80 dark:bg-slate-800/50 backdrop-blur-xl 
      border border-white/60 dark:border-slate-600/40
      shadow-sm hover:shadow-md dark:hover:shadow-blue-500/10`}
    >
...
const DashboardOverview = ({ theme }) => {
  ...
  return (
    <div
      ...
      /* 1. BACKGROUND GRADIENT (Sama seperti MainLayout) */
      bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 
      dark:from-slate-900 dark:via-slate-800 dark:to-slate-900
      transition-colors duration-300"
    >
      {/* 2. AURORA / GLOW EFFECT (Sama seperti MainLayout) */}
      ...
      {/* Content Wrapper (Relative + Z-10 agar di atas background) */}
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 items-start">
          ...
          <div className="xl:col-span-2 space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                {data?.actions?.length > 0 ? (
                  ...
                  <div className="p-10 text-center rounded-2xl border border-dashed border-slate-300 dark:border-slate-700
                  /* [UPDATE] Background & Border Kartu Kosong */
                  bg-white/80 dark:bg-slate-800/50 backdrop-blur-xl">
            ...
            <section>
              ...
              /* [UPDATE] Background & Border Tabel */
              bg-white/80 dark:bg-slate-800/50 backdrop-blur-xl 
              border border-white/60 dark:border-slate-600/40">
                {/* Table Header & Filter */}
          ...
          {/* KOLOM KANAN (Summary Chart) */}
          <div className="xl:col-span-1">
            <div className="sticky top-6">
              <div className="rounded-2xl shadow-sm p-6
              /* [UPDATE] Background & Border Kartu Ringkasan */
              bg-white/80 dark:bg-slate-800/50 backdrop-blur-xl 
              border border-white/60 dark:border-slate-600/40">
