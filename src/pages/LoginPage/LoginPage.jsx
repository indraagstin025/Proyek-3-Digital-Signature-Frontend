...
const LoginPage = () => {
  ...
  // Handler agar saat user mengetik ulang, error hilang
      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-5" noValidate>
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                <HiOutlineMail className={`w-5 h-5 ${validationErrors.email ? "text-red-500" : "text-slate-400 dark:text-gray-400"}`} />
              </span>
              <input
                id="email"
                type="email"
            ...
            {validationErrors.email && (
              <p className="mt-1 text-xs text-red-500 font-medium flex items-center gap-1">
                <HiExclamationCircle /> {validationErrors.email}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                <HiOutlineLockClosed className={`w-5 h-5 ${validationErrors.password ? "text-red-500" : "text-slate-400 dark:text-gray-400"}`} />
              </span>
              <input
                id="password"
